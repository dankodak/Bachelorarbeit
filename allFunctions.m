function [rbf, lap_rbf, lap2_rbf, f, w, realSol, realSolPlot] = allFunctions(kernel, pde)
...
%         rbfs(gammas,a,b,c,d) = (1 - gammas*((c-a)^2 + (d-b)^2))^4 * (4*gammas*((c-a)^2 + (d-b)^2) + 1)/(20*gammas^2);
        ...
        lap2_rbf1 = matlabFunction(diff(prods,a,4) + diff(prods,b,4) + 2*diff(diff(prods,a,2),b,2));

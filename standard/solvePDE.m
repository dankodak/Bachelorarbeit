...
for i = 1:length(gamma)
    ...
    A_Lambda = collocation_matrix(rbf, lap_rbf, lap2_rbf, gamma(i), Xin, Xbd, symmetric);
    % LGS lösen
    alpha = A_Lambda\b;
    
    %Vergleich
    error(i) = calculate_error(alpha, Xin, Xbd, Xte, gamma(i), rbf, lap_rbf, lap2_rbf, f, w, realSol, symmetric);
...
while bestgamma == gamma(1)
    ...
    alpha = A_Lambda\b;
    error = [calculate_error(alpha, Xin, Xbd, Xte, gamma(i), rbf, lap_rbf, lap2_rbf, f, w, realSol, symmetric) error];
...
while bestgamma == gamma(end)
    ...
    error = [error calculate_error(alpha, Xin, Xbd, Xte, gamma(i), rbf, lap_rbf, lap2_rbf, f, w, realSol, symmetric)];
